#!/bin/sh
#
# DCENTos post-image script — am2-t17 (T17 Zynq am2 17-series variant)
...
#
# CRITICAL — :
#   BOARD_NAME must be "am2-t17" (not any sibling 17-series target).
...
BOARD_NAME="am2-t17"
BOARD_FAMILY="am2"
OUTPUT_TAR="${BINARIES_DIR}/dcentos-sysupgrade-am2-t17.tar"

echo "=== DCENTos Post-Image Builder (am2-t17) ==="
...
if [ ! -f "$ROOTFS" ]; then
    ...
    echo "  Enable BR2_TARGET_ROOTFS_SQUASHFS=y in the am2-t17 defconfig." >&2
    exit 1
fi
...
infer_package_version() {
    ...
    for candidate in \
        ...
        "${PROJECT_ROOT}/br2_external_dcentos/board/zynq/am2-t17/rootfs-overlay/etc/dcentos-version" \
...
=== DCENTos am2-t17 Build Info (EXPERIMENTAL package) ===
...
echo ""
echo "=== Build Complete (am2-t17 — EXPERIMENTAL package, no live proof) ==="
